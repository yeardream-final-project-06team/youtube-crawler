...
persona_list = [
    ...
    ["K-POP 팬", "케이팝,아티스트분석,아이돌,팬커뮤니티,댄스"],
    ["드라마 리뷰어", "드라마리뷰,배우인터뷰,에피소드해설,요약본,몰아보기"],
    ["예능 프로그램 애호가", "예능,하이라이트,베스트클립,리액션,예능레전드"],
    ["강아지 훈련 전문가", "강아지훈련,행동교정,반려견,애완동물관리,애견훈련사"],
    ["히스토리 텔러", "역사,한국사,히스토리,역사강의,역사이야기"],
    ["심리 카운셀러", "심리학,상담,심리치료사,심리테스트,검사"],
    ["리걸 어드바이저", "법률,상담,법률정보,변호사,소송,법률자문"],
    ["경제 교육가", "경제원리,이론,경제사,경제교육,경제학자"],
    ["조경 디자이너", "조경,디자인,정원,조경아이디어,조경디자인팁"],
    ["프로축구 해설가", "경기분석,축구,축구해설,하이라이트,해외축구"],
    ["야구 엔터테이너", "야구하이라이트,선수인터뷰,사회인야구,야구직관,"],
    ["빈티지 패션 컬렉터", "빈티지패션,스타일링팁,쇼핑가이드,빈티지아이템"],
    ["패션 DIY 크리에이터", "패션,헌옷,리폼,패션재활용,옷만들기"],
    ["코딩 마스터", "코딩,프로그래밍,튜토리얼,개발팁,프로그래밍언어"],
    ["스타트업 핵심인물", "스타트업,비즈니스,창업,기업가치,투자"],
    ["음악 프로듀서", "음악제작,프로듀싱팁,장비리뷰,음악프로듀서"],
    ["인디 음악 애호가", "인디음악,음악추천,아티스트인터뷰,음악리뷰"],
    ["IT 트렌드 워처", "정보기술트렌드,기술뉴스,산업동향,최신기술"],
    ["게임 개발자", "게임개발,인디게임,게임디자인,개발자,프로그래밍"],
    ["건축 마스터", "건축,디자인,건축가,건축디자인,건축물"],
    ["백패커 가이드", "백패킹,저렴한여행,배낭여행,숙박추천,가성비"],
    ["비건 요리 전문가", "비건,샐러드,식재료,채식,요리팁"],
    ["러닝 열정가", "러닝,조깅,러닝팁,러닝화,마라톤"],
    ["보컬 코치", "노래,가이드,보컬,트레이닝,레슨,보컬트레이너"],
    ["스트리트 패션리스타", "스트리트패션,트렌드,옷조합,패션리뷰,브랜드"],
    ["캠핑 마스터", "캠핑,아웃도어,캠핑가이드,캠핑팁,캠핑장비"],
    ["판타지 사이언티스트", "공상과학,이론,사이언스,이야기"],
    ["테이블 세팅 아티스트", "테이블세팅,홈파티,디너파티,인테리어,세팅아이디어"],
    ["드론 마스터", "드론,비디오촬영,촬영팁,드론비디오,비디오편집"],
    ["문화 탐험가", "세계문화,역사적장소,예술작품,문화탐험,여행가이드"],
    ["재즈 열정가", "재즈음악,아티스트소개,재즈공연,음악감상"],
    ["미니멀리스트", "미니멀리즘,미니멀라이프,미니멀,일상,라이프스타일"],
    ["수학 마스터", "수학문제해설,수학공식,공부팁,수학학습"],
    ["럭셔리 트래블러", "럭셔리여행,고급호텔,호텔식당,브이로그"],
